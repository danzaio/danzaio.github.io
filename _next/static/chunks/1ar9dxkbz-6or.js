...
`,el=!1;!function(){if(el||typeof document>"u")return;if(document.getElementById(en)){el=!0;return}let e=document.createElement("style");e.id=en,e.textContent=ei,document.head.appendChild(e),el=!0}();let es={position:"absolute",inset:0,width:"100%",height:"100%"},ec={position:"absolute",inset:3},ed={position:"absolute",inset:0,pointerEvents:"none",zIndex:3,borderRadius:"inherit"},eu=new Map;w=(e,t)=>{let r=eu.get(e);r&&function(e,t,r,a,o="dark"){var n,i,s,c,d;let u,p,f,{width:m,height:y,cornerRadius:w,perim:_}=e;if(0===_.length)return;let M=-1,k=e.currentIdx,C=0;for(let r=0;r<_.length;r++){let a=_[r],o=b(t,a.x,a.y,2);o>M&&(M=o,k=r),r===e.currentIdx&&(C=o)}let S=e.appearedAt>0&&r-e.appearedAt<3e3,R=.34+.51*G(.08,.32,C),O=!S&&M-C>.05;if(!e.relocTween||e.relocTween.done)if(0===e.appearedAt)e.currentIdx=k,e.appearedAt=r,e.wanderS=0,e.wanderTargetS=0,e.wanderFrames=0,e.relocTween=P(0,R,1500,T),$(e.relocTween,r);else if(null!=(n=e.relocTween)&&n.done&&0===e.relocTween.to){e.currentIdx=e.relocNextIdx,e.appearedAt=r,e.wanderS=0,e.wanderTargetS=0,e.wanderFrames=0;let a=_[e.currentIdx];e.relocTween=P(0,.34+.51*G(.08,.32,b(t,a.x,a.y,2)),1500,T),$(e.relocTween,r)}else O?(e.relocNextIdx=k,e.relocTween=P(e.glowOpacity,0,1500,T),$(e.relocTween,r)):e.glowOpacity+=(R-e.glowOpacity)*.00875;e.relocTween&&(e.glowOpacity=A(e.relocTween,r)),e.glowOpacity=Math.max(0,Math.min(1,e.glowOpacity));let I=B(m,y,w,e.kind)/L(140,40,20);e.wanderFrames++>=120&&(e.wanderTargetS=15*I*(2*Math.random()-1),e.wanderFrames=0),e.wanderS+=(e.wanderTargetS-e.wanderS)*.0075;let F=_[e.currentIdx].arc+e.wanderS,E=1.5*e.scale;N(F,m,y,w,E,0,e.kind,q);let z=q.x,H=q.y,D=(N(F-.1,m,y,w,E,0,i=e.kind,W),N(F+.1,m,y,w,E,0,i,j),Math.atan2(j.y-W.y,j.x-W.x)),U=`translate(${z.toFixed(3)}px,${H.toFixed(3)}px) rotate(${D.toFixed(4)}rad)`;e.haloInner.style.transform=U,N(F,m,y,w,E,I*e.scale,e.kind,q),e.extraInner.style.transform=`translate(${q.x.toFixed(3)}px,${q.y.toFixed(3)}px) rotate(${D.toFixed(4)}rad)`,e.fadeCircle.style.transform=`translate(${q.x.toFixed(3)}px,${q.y.toFixed(3)}px)`;let V="light"===o,Q=V?function(e,t,r){if(!l)return v.r=255,v.g=255,v.b=255,v;h();let a=g(e,t,r),{glowPixels:o,glowPixelsW:n,glowPixelsH:i}=l,s=Math.max(0,a.bx-2),c=Math.min(n,a.bx+2+1),d=Math.max(0,a.by-2),u=Math.min(i,a.by+2+1),p=-1;v.r=255,v.g=255,v.b=255;for(let e=d;e<u;e++){let t=e*n;for(let e=s;e<c;e++){let r=(t+e)*4,a=o[r],n=o[r+1],i=o[r+2],l=Math.max(a,n,i),s=Math.min(a,n,i),c=(l>0?(l-s)/l:0)*(.35+l/255*.65);c>p&&(p=c,v.r=a,v.g=n,v.b=i)}}return v}(t,z,H):function(e,t,r){if(!l)return v.r=255,v.g=255,v.b=255,v;h();let a=g(e,t,r),o=x(l.glowPixels,l.glowPixelsW,l.glowPixelsH,a.bx,a.by,2);return 0===o.count?(v.r=255,v.g=255,v.b=255):(v.r=o.r/o.count,v.g=o.g/o.count,v.b=o.b/o.count),v}(t,z,H);e.tintTween?e.tintTween.done&&(V?(e.tintFrom={r:e.tintFrom.r+(e.tintTarget.r-e.tintFrom.r)*e.tintTween.val,g:e.tintFrom.g+(e.tintTarget.g-e.tintFrom.g)*e.tintTween.val,b:e.tintFrom.b+(e.tintTarget.b-e.tintFrom.b)*e.tintTween.val},e.tintTarget={...Q},e.tintTween=P(0,1,400),$(e.tintTween,r)):r>=e.tintHoldUntil&&(e.tintFrom={...e.tintTarget},e.tintTarget={...Q},e.tintTween=P(0,1,400),$(e.tintTween,r),e.tintHoldUntil=r+2e3)):(e.tintFrom={...Q},e.tintTarget={...Q},e.tintTween=P(0,1,400),$(e.tintTween,r),e.tintHoldUntil=V?0:r+2e3),A(e.tintTween,r);let X=e.tintTween.val;if(V)u=Math.round(e.tintFrom.r+(e.tintTarget.r-e.tintFrom.r)*X),p=Math.round(e.tintFrom.g+(e.tintTarget.g-e.tintFrom.g)*X),f=Math.round(e.tintFrom.b+(e.tintTarget.b-e.tintFrom.b)*X);else{let t=e.tintFrom.r+(e.tintTarget.r-e.tintFrom.r)*X,r=e.tintFrom.g+(e.tintTarget.g-e.tintFrom.g)*X,a=e.tintFrom.b+(e.tintTarget.b-e.tintFrom.b)*X,o=Math.max(t,r,a)||1;u=Math.round(t/o*255),p=Math.round(r/o*255),f=Math.round(a/o*255)}let K=`rgb(${u},${p},${f})`;if(K!==e.lastHaloStroke&&(e.lastHaloStroke=K,e.haloInner.style.stroke=K),V){let t,r,a,o=(r=(t=Math.max(s=u/255,c=p/255,d=f/255))-Math.min(s,c,d),a=0,0!==r&&(a=(t===s?((c-d)/r+6)%6:t===c?(d-s)/r+2:(s-c)/r+4)/6),[a,0===t?0:r/t,t]),[n,i,l]=function(e,t,r){let a=Math.floor(6*e),o=6*e-a,n=r*(1-t),i=r*(1-o*t),l=r*(1-(1-o)*t),s=0,c=0,d=0;switch(a%6){case 0:s=r,c=l,d=n;break;case 1:s=i,c=r,d=n;break;case 2:s=n,c=r,d=l;break;case 3:s=n,c=i,d=r;break;case 4:s=l,c=n,d=r;break;case 5:s=r,c=n,d=i}return[Math.round(255*s),Math.round(255*c),Math.round(255*d)]}(o[0],Math.min(1,2.625*o[1]),Math.max(.31,1.008*o[2])),h=`rgb(${n},${i},${l})`;h!==e.lastExtraStroke&&(e.lastExtraStroke=h,e.extraInner.style.stroke=h)}else"#ffffff"!==e.lastExtraStroke&&(e.lastExtraStroke="#ffffff",e.extraInner.style.stroke="#ffffff");let Y=Math.max(0,Math.min(1,a));e.haloGroup.style.opacity=(.8*e.glowOpacity*Y).toFixed(3),e.extraGroup.style.opacity=Math.min(1,3.51*e.glowOpacity*Y).toFixed(3)}(r.handles,e,t,e.opacityMul,r.themeRef.current)};let ep=(0,r.forwardRef)(function({children:e,variant:o="button",preset:n="chromatic",theme:i="auto",strength:s=1,paused:c=!1,borderRadius:d,normalizeHostStyles:p=!0,reflectionTargets:h,disableGlow:f=!1,shaderScale:g,ringCssPx:m,scale:x=1,className:v,style:b,...w},M){let k=(0,r.useRef)(null),R=(0,r.useRef)(null),T=(0,r.useRef)(null),P=(0,r.useRef)(null),$=(0,r.useRef)(null),A=(0,r.useRef)(null),O=(0,r.useRef)("dark"),I=(0,r.useRef)(0),[F,E]=(0,r.useState)(!1),z=function(e){let[t,a]=(0,r.useState)(()=>"auto"!==e?e:typeof window>"u"||!window.matchMedia||window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light");return(0,r.useEffect)(()=>{if("auto"!==e)return void a(e);if(typeof window>"u"||!window.matchMedia)return;let t=window.matchMedia("(prefers-color-scheme: dark)"),r=()=>a(t.matches?"dark":"light");return r(),t.addEventListener("change",r),()=>t.removeEventListener("change",r)},[e]),t}(i);O.current=z;let L="circle"===o?"circle":"pill";(0,r.useImperativeHandle)(M,()=>k.current,[]);let B=(e,t)=>"circle"===L?Math.min(e,t)/2:Math.min("number"==typeof d?d:(()=>{var e;let t=null==(e=P.current)?void 0:e.firstElementChild;if(t){let e=parseFloat(getComputedStyle(t).borderTopLeftRadius);if(Number.isFinite(e)&&e>0)return e}return I.current})(),Math.min(e,t)/2);(0,r.useEffect)(()=>{let e;(e=u()).preset=a[n].modes[z],e.presetDirty=!0},[n,z]),(0,r.useEffect)(()=>{let e=$.current;e&&y(e,{paused:c})},[c]),(0,r.useEffect)(()=>{let e=$.current;if(!e)return;let t={};void 0!==g&&(t.shaderScale=g),void 0!==m&&(t.ringCssPx=m),void 0!==x&&(t.scale=x),Object.keys(t).length>0&&y(e,t)},[g,m,x]),(0,r.useLayoutEffect)(()=>{var e;let t=R.current,r=k.current,a=T.current;if(!t||!r)return;{let e=parseFloat(getComputedStyle(r).borderTopLeftRadius);I.current=Number.isFinite(e)?e:0}let o=()=>{let e=r.getBoundingClientRect(),t=Math.max(1,Math.round(e.width)),a=Math.max(1,Math.round(e.height));return{cssWidth:t,cssHeight:a,cornerRadius:B(t,a)}},n=o();$.current=function(e){let t=u(),r=e.hostCanvas.getContext("2d",{alpha:!0});if(!r)throw Error("metal-fx: canvas 2D context unavailable");let a=e.scale??1,o={canvas:e.hostCanvas,ctx:r,cssWidth:e.cssWidth,cssHeight:e.cssHeight,cornerRadius:e.cornerRadius,kind:e.kind,ringCssPx:e.ringCssPx??("circle"===e.kind?2:1)*a,shaderScale:e.shaderScale??("circle"===e.kind?1.3:1.6)*a,opacityMul:e.opacityMul??1,visible:!0,paused:e.paused??!1,everCopied:!1,dpr:"u">typeof window&&window.devicePixelRatio||1,scale:a,onAfterFrame:e.onAfterFrame,onFirstCopy:e.onFirstCopy};return _(o),t.instances.add(o),0===t.rafId&&null===t.pausedAtMs&&C(),o}({hostCanvas:t,cssWidth:n.cssWidth,cssHeight:n.cssHeight,cornerRadius:n.cornerRadius,kind:L,paused:c,shaderScale:g,ringCssPx:m,scale:x,onFirstCopy:()=>E(!0)}),r.style.setProperty("--mfx-radius",`${n.cornerRadius}px`),r.style.borderRadius=`${n.cornerRadius}px`,a&&(A.current=V(a,{width:n.cssWidth,height:n.cssHeight,cornerRadius:n.cornerRadius,kind:L,scale:x}));let i=0,s=new ResizeObserver(()=>{0===i&&(i=requestAnimationFrame(()=>{i=0;let e=o(),t=$.current;t&&(y(t,{cssWidth:e.cssWidth,cssHeight:e.cssHeight,cornerRadius:e.cornerRadius}),r.style.setProperty("--mfx-radius",`${e.cornerRadius}px`),r.style.borderRadius=`${e.cornerRadius}px`,a&&(a.innerHTML="",A.current=V(a,{width:e.cssWidth,height:e.cssHeight,cornerRadius:e.cornerRadius,kind:L,scale:x}),t&&A.current&&eu.set(t,{handles:A.current,themeRef:O})))}))});s.observe(r);let d=null;return"u">typeof IntersectionObserver&&(d=new IntersectionObserver(e=>{let t=$.current;if(t)for(let a of e){var r;t.visible=r=a.isIntersecting,r&&l&&0===l.rafId&&null===l.pausedAtMs&&!l.contextLost&&C()}},{rootMargin:"64px"})).observe(r),$.current&&A.current&&(eu.set($.current,{handles:A.current,themeRef:O}),e=$.current,l&&(l.glowQueue.includes(e)||l.glowQueue.push(e))),()=>{s.disconnect(),null==d||d.disconnect(),0!==i&&cancelAnimationFrame(i);let e=$.current;e&&(eu.delete(e),function(e){if(!l)return;let t=l.glowQueue.indexOf(e);-1!==t&&l.glowQueue.splice(t,1)}(e),function(e){if(!l)return;l.instances.delete(e);let t=l.glowQueue.indexOf(e);-1!==t&&l.glowQueue.splice(t,1),0===l.instances.size&&(S(),function(){var e;if(!l)return;let{gl:t,program:r,buffer:a,frameBitmap:o}=l;try{null==o||o.close(),t.deleteBuffer(a),t.deleteProgram(r),null==(e=t.getExtension("WEBGL_lose_context"))||e.loseContext()}catch{}l=null}())}(e)),$.current=null,A.current=null,a&&(a.innerHTML="")}},[L]),(0,r.useEffect)(()=>{let e=$.current;e&&y(e,{opacityMul:Math.max(0,Math.min(1,s))})},[s,o]),(0,r.useEffect)(()=>{let e=$.current,t=k.current;if(!e||!t||!h||"dark"!==z)return;e.onAfterFrame=eo;let r=h.flatMap(e=>e.current?[e.current]:[]);for(let a of r)!function(e,t,r){if(typeof document>"u"||Q.has(e.tagName))return;for(let t of et)if(t.el===e)return t;let a=document.createElement("div");a.setAttribute("data-metal-fx-reflection",""),a.setAttribute("aria-hidden","true");let o=document.createElement("canvas");o.className="metal-fx-reflection-canvas";let n=o.getContext("2d",{alpha:!0});if(!n)return;let i=document.createElement("canvas");i.className="metal-fx-reflection-stroke-canvas";let l=i.getContext("2d",{alpha:!0});if(!l)return;a.appendChild(o),a.appendChild(i);let s=getComputedStyle(e),c=!1;"static"===s.position&&(e.style.position="relative",c=!0);let d=!1;"isolate"!==s.isolation&&(e.style.isolation="isolate",d=!0),e.setAttribute("data-metal-fx-reflect-host",""),e.insertBefore(a,e.firstChild);let u=Z(e),p={el:e,anchor:t,anchorEl:r,wrap:a,canvas:o,ctx:n,strokeCanvas:i,strokeCtx:l,cornerRadius:J(e),hairlineWidth:u.width,hairlineOuterCssPx:u.outerCssPx,appliedPositionRelative:c,appliedIsolation:d,resizeObserver:null,mutationObserver:null};"u">typeof ResizeObserver&&(p.resizeObserver=new ResizeObserver(()=>ee(p)),p.resizeObserver.observe(p.el)),"u">typeof MutationObserver&&(p.mutationObserver=new MutationObserver(()=>ee(p)),p.mutationObserver.observe(p.el,{attributes:!0,attributeFilter:["style","class"]})),et.add(p)}(a,e,t);return()=>{for(let t of(e.onAfterFrame=void 0,r))!function(e){for(let t of et)if(t.el===e){(function(e){var t,r;null==(t=e.resizeObserver)||t.disconnect(),e.resizeObserver=null,null==(r=e.mutationObserver)||r.disconnect(),e.mutationObserver=null})(t),t.canvas.width=0,t.canvas.height=0,t.strokeCanvas.width=0,t.strokeCanvas.height=0,t.wrap.parentNode===t.el&&t.el.removeChild(t.wrap),t.el.removeAttribute("data-metal-fx-reflect-host"),t.appliedPositionRelative&&(t.el.style.position=""),t.appliedIsolation&&(t.el.style.isolation=""),et.delete(t);return}}(t)}},[h,z]),(0,r.useEffect)(()=>{let e=k.current,t=$.current;if(!e||!t)return;let r=B(t.cssWidth,t.cssHeight);y(t,{cornerRadius:r}),e.style.setProperty("--mfx-radius",`${r}px`),e.style.borderRadius=`${r}px`},[d,z,o,L]);let N=(0,r.useMemo)(()=>({...b,"--mfx-strength":String(Math.min(1,Math.max(0,s))),opacity:+!!F,visibility:F?"visible":"hidden",transition:F?"opacity 0.15s ease-out":"none"}),[b,s,F]);return(0,t.jsxs)("div",{...w,ref:k,className:v?`metal-fx-root ${v}`:"metal-fx-root","data-variant":o,"data-shape":L,"data-theme":z,"data-paused":c?"true":void 0,"data-normalize":p?"true":"false",style:N,children:[(0,t.jsx)("canvas",{ref:R,className:"metal-fx-canvas",style:es}),(0,t.jsx)("div",{className:"metal-fx-inner","aria-hidden":"true",style:ec}),(0,t.jsx)("div",{ref:T,"aria-hidden":"true",style:{...ed,display:f?"none":void 0}}),(0,t.jsx)("div",{ref:P,className:"metal-fx-content",children:e})]})});ep.displayName="MetalFx",e.s(["MetalFx",0,ep])},41513,49382,e=>{"use strict";var t=e.i(43476),r=e.i(71645),a=e.i(25913),o=e.i(40604),n=e.i(75157),i=e.i(19455);let l=(0,a.cva)("transition-colors",{variants:{variant:{default:"bg-primary! text-primary-foreground! hover:bg-primary/80!",outline:"bg-background! text-foreground! hover:bg-input/50! dark:bg-input/30!",secondary:"bg-secondary! text-secondary-foreground! hover:bg-secondary/80!",ghost:"bg-transparent! text-foreground! hover:bg-muted/50! dark:hover:bg-muted/50!",destructive:"bg-destructive/10! text-destructive! hover:bg-destructive/20! dark:bg-destructive/20! dark:hover:bg-destructive/30!",link:"bg-transparent! text-primary!"}},defaultVariants:{variant:"default"}}),s=(0,r.forwardRef)(function({metalVariant:e="button",metalFxClassName:r,metalFxStyle:a,preset:s="chromatic",theme:c="auto",strength:d=.9,paused:u,borderRadius:p,disableGlow:h,reflectionTargets:f,shaderScale:g,ringCssPx:m,scale:x,normalizeHostStyles:v=!0,variant:b="default",className:y,...w},_){return(0,t.jsx)(o.MetalFx,{borderRadius:p,className:(0,n.cn)("overflow-visible! inline-flex w-fit min-w-0 flex-col items-stretch leading-none","relative isolate before:pointer-events-none before:absolute before:inset-0 before:z-10 before:rounded-[inherit] before:ring-1 before:ring-border/70 before:ring-inset dark:before:ring-border/80",v&&l({variant:b}),r),disableGlow:h,normalizeHostStyles:v,paused:u,preset:s,ref:_,reflectionTargets:f,ringCssPx:m,scale:x,shaderScale:g,strength:d,style:a,theme:c,variant:e,children:(0,t.jsx)(i.Button,{className:(0,n.cn)(v&&"border-0! bg-transparent! shadow-none! hover:bg-transparent! aria-expanded:bg-transparent!",y),variant:b,...w})})});s.displayName="MetalButton",(0,r.forwardRef)(function({size:e="icon-sm",metalVariant:r="circle",className:a,...o},i){return(0,t.jsx)(s,{className:(0,n.cn)("leading-none! [&_svg]:block [&_svg]:shrink-0",a),metalVariant:r,ref:i,size:e,...o})}).displayName="MetalIconButton",e.s(["MetalButton",0,s],41513);let c={dots:"bg-[radial-gradient(circle_at_1px_1px,rgba(0,0,0,0.4)_1px,transparent_0)] bg-[length:8px_8px]",grid:"bg-[linear-gradient(rgba(0,0,0,0.3)_1px,transparent_1px),linear-gradient(90deg,rgba(0,0,0,0.3)_1px,transparent_1px)] bg-[length:12px_12px]",noise:"bg-[radial-gradient(circle_at_2px_2px,rgba(0,0,0,0.25)_1px,transparent_0)] bg-[length:6px_6px]",crosshatch:"bg-[repeating-linear-gradient(45deg,transparent,transparent_2px,rgba(0,0,0,0.3)_2px,rgba(0,0,0,0.3)_4px),repeating-linear-gradient(-45deg,transparent,transparent_2px,rgba(0,0,0,0.3)_2px,rgba(0,0,0,0.3)_4px)]",diagonal:"bg-[repeating-linear-gradient(-45deg,rgba(0,0,0,0.2),rgba(0,0,0,0.2)_1px,transparent_1px,transparent_6px)]",scatteredDots:"bg-[radial-gradient(circle_at_3px_7px,rgba(0,0,0,0.3)_1px,transparent_0),radial-gradient(circle_at_11px_2px,rgba(0,0,0,0.3)_1px,transparent_0),radial-gradient(circle_at_7px_12px,rgba(0,0,0,0.3)_1px,transparent_0)] bg-[length:16px_16px]",halftone:"bg-[radial-gradient(circle,rgba(0,0,0,0.4)_25%,transparent_25%)] bg-[length:10px_10px] bg-[position:0_0,5px_5px]",triangular:"bg-[conic-gradient(from_0deg_at_50%_50%,rgba(0,0,0,0.3)_0deg_120deg,transparent_120deg_240deg,rgba(0,0,0,0.3)_240deg_360deg)] bg-[length:8px_8px] bg-[position:0_0,4px_4px]",chevron:"bg-[repeating-linear-gradient(45deg,rgba(0,0,0,0.2)_0px,rgba(0,0,0,0.2)_2px,transparent_2px,transparent_8px),repeating-linear-gradient(-45deg,rgba(0,0,0,0.2)_0px,rgba(0,0,0,0.2)_2px,transparent_2px,transparent_8px)]",paperGrain:"bg-[repeating-linear-gradient(0deg,rgba(0,0,0,0.1)_0px,transparent_1px,transparent_3px),repeating-linear-gradient(90deg,rgba(0,0,0,0.1)_0px,transparent_1px,transparent_4px),repeating-linear-gradient(45deg,rgba(0,0,0,0.05)_0px,transparent_1px,transparent_5px)]",horizontalLines:"bg-[repeating-linear-gradient(0deg,rgba(0,0,0,0.25)_0px,rgba(0,0,0,0.25)_1px,transparent_1px,transparent_4px)]",verticalLines:"bg-[repeating-linear-gradient(90deg,rgba(0,0,0,0.25)_0px,rgba(0,0,0,0.25)_1px,transparent_1px,transparent_4px)]",none:""},d={dots:1,grid:1,noise:1,crosshatch:1,diagonal:1,scatteredDots:1,halftone:1,triangular:1,chevron:1,paperGrain:1,horizontalLines:1,verticalLines:1,none:0};e.s(["TextureOverlay",0,function({texture:e,opacity:r,className:a}){if("none"===e)return null;let o=r??d[e],i=c[e];return(0,t.jsx)("div",{className:(0,n.cn)("absolute inset-0 pointer-events-none",i,a),style:{opacity:o}})}],49382)}]);